 ...
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |RotEnc| Alt  | Nav  | Space| Ent  |  | Del  | Bspc |SYMBL | Alt |RotEnc|
 *                        `----------------------------------'  `----------------------------------'
 */
    [QWERTY] = LAYOUT(
      ...
      KC_LCTL, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,
              XXXXXXX, KC_LALT, MO(NAV), KC_SPC, KC_ENT, KC_DEL, KC_BSPC, MO(SYMBOLS), KC_LALT, LCTL(LSFT(LALT(KC_F1)))
    ),
/*
 * NAV Layer: Nav, Numpa
 *
 * ,-------------------------------------------.                              ,-------------------------------------------.
 * |        |      |   7  |   8  |   9  |  Up  |                              | PgUp | Home |  Up  |  End |      |        |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |  Tab   |      |   4  |   5  |   6  | Down |                              | PgDn | Left | Down | Right|      |        |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |        |      |   1  |   2  |   3  |  0   |      |      |  |      |      |  -   |      |      |      |      |        |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 ...
 */
    [NAV] = LAYOUT(
      _______, _______, KC_7, KC_8, KC_9, KC_UP,                                     KC_PGUP, KC_HOME, KC_UP, KC_END, _______, _______,
      KC_TAB, _______, KC_4, KC_5, KC_6, KC_DOWN,                                     KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
 ...
 */
    [SYMBOLS] = LAYOUT(
      _______, _______, _______, KC_LCBR, KC_RCBR, KC_PIPE,                                     KC_PLUS, KC_AMPR, KC_ASTR, LSFT(KC_MINS),_______, _______,
      KC_CAPS, _______, _______, KC_LPRN, KC_RPRN, KC_GRV,                                      KC_EQL, KC_DLR, KC_PERC, KC_CIRC, _______, _______,
      _______, KC_LGUI, _______, KC_LBRC, KC_RBRC, KC_TILD, _______, _______, _______, _______, KC_MINS, KC_EXLM,  KC_AT, KC_HASH,  _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
/*
 * MACROS Layer
